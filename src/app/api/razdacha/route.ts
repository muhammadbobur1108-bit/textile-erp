...
export async function GET(req: NextRequest) {
  try {
    ...
    if (potok) { cond.push(`potok ILIKE $${i++}`); vals.push(`%${potok}%`) }
...
export async function POST(req: NextRequest) {
  try {
    ...
    const result = await sql`
      INSERT INTO razdacha (sana, buyurtma, model, rang, nastil_no, rost, razmer, tekshirish,
        unik_kod, sort, potok, razdacha_son, brak_vozvrat)
      VALUES (${b.sana}, ${b.buyurtma}, ${b.model}, ${b.rang}, ${b.nastil_no}, ${b.rost},
        ${b.razmer}, ${b.tekshirish}, ${b.unik_kod}, ${b.sort||1}, ${b.potok},
        ${b.razdacha_son||0}, ${b.brak_vozvrat||0})
      RETURNING *
    `
